...
public class HomePageServlet extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        Announcement ann = annDAO.getAnnByCreateLater();
        request.setAttribute("ann", ann);
        
        List<Course> listCourse = courseDAO.get4CourseApproved();
        request.setAttribute("listCourse", listCourse);
        
        request.getRequestDispatcher("homePage_Guest.jsp").forward(request, response);
    }
