...
<html>
    <head>
        <meta charset="UTF-8">
        <title>Update Material | F-Skill</title>
    ...
    <body>
                ...
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item inline-flex items-center">
                            <a class="text-indigo-600 hover:text-indigo-700 font-medium no-underline"
                               href="${pageContext.request.contextPath}/instructor">Home</a>
                        </li>
                        <li class="breadcrumb-item inline-flex items-center">
                            <a class="text-indigo-600 hover:text-indigo-700 font-medium no-underline"
                               href="${pageContext.request.contextPath}/instructor/courses/modules?courseId=${course.courseID}">${course.courseName}</a>
                        </li>
                        <li class="breadcrumb-item inline-flex items-center">
                            <a class="text-indigo-600 hover:text-indigo-700 font-medium no-underline"
                               href="${pageContext.request.contextPath}/instructor/courses/modules/material?moduleId=${module.moduleID}&courseId=${course.courseID}">
                                ${module.moduleName}
                            </a>
                        </li>
                    ...
                    <form method="POST" action="${pageContext.request.contextPath}/instructor/courses/modules/material?action=update"
                        ...
                        <div class="row g-4">
                            ...
                            <div class="col-md-6 d-none" id="youtubeLinkDiv">
                                ...
                                <input type="url" id="youtubeLinkInput" name="materialVideo" class="form-control"
                                       placeholder="https://www.youtube.com/..."
                                       pattern="https?://.+" title="Must start with http:// or https://"
                                       value="${material.type == 'video' ? material.materialUrl : ''}"
                            ...
                            <div class="col-12">
                                ...
                                <textarea name="materialDescription" class="form-control" rows="4"
                                          placeholder="Enter description...">${material.materialDescription}</textarea>
                            </div>
        ...
        <!-- Video Modal -->
        <c:if test="${material.type == 'video' && not empty material.materialUrl}">
            <c:set var="videoId" value="" />
            <c:if test="${fn:contains(material.materialUrl, 'embed/')}">
        ...
        <script>
            ...
            function toggleInputFields() {
                ...
                if (!youtubeDiv || !fileDiv || !linkDiv || !videoDurationDiv) {
                    console.error("One or more required divs are missing.");
                    return;
                }
                ...
                // Hiển thị div tương ứng với type
                if (type === "video") {
            ...
            function validateYoutubeFields() {
                ...
                const urlErrorDiv = document.getElementById("youtubeUrlError") || document.createElement("div");
