...
<html>
    ...
    <body>
        ...
        <div class="container px-5 py-6">
            ...
            <h2 class="mb-4 fw-bold fs-3">Create Course</h2>
            <form id="createCourseForm" action="${pageContext.request.contextPath}/instructor/courses?action=create" method="POST" enctype="multipart/form-data">
