...
<head>
    ...
    <style>
        ...
        .edit-button {
            ...
            color: white;
            <c:if test="${editMode == true}"> display: none;
        </c:if>
        }
                        ...
                        <form id="updateUserForm" action="updateUserServlet" method="POST">
                            <div class="detail-grid">
                                ...
                                <div class="detail-item">
                                    ...
                                    <input type="text" id="inputDisplayName" name="displayName" class="detail-input"
                                           value="${param.displayName != null ? param.displayName : user.displayName}"
                                           required>
                                ...
                                <div class="detail-item">
                                    ...
                                    <input type="email" id="inputEmail" name="email" class="detail-input"
                                ...
                                <div class="detail-item">
                                    ...
                                    <select id="inputBanStatus" name="ban" class="detail-input">
                                        <option value="NORMAL"
                                                <c:if test="${(param.ban != null && param.ban == 'NORMAL') || (param.ban == null && user.ban == 'NORMAL')}">selected</c:if>>
                                            NORMAL
                                        </option>
                                        <option value="BANNED"
                                                <c:if test="${(param.ban != null && param.ban == 'BANNED') || (param.ban == null && user.ban == 'BANNED')}">selected</c:if>>
                                            BANNED
                                        </option>
                                    </select>
                                ...
                                <div class="detail-item">
                                    ...
                                    <input type="text" id="inputPhone" name="phone" class="detail-input"
                                ...
                                <div class="detail-item">
                                    ...
                                    <span class="detail-value"
                                          id="displayInfo">${user.info != null ? user.info : "No information here !"}</span>
                                    <textarea id="inputInfo" name="info" class="detail-input"
                                              rows="3">${param.info != null ? param.info : (user.info != null ? user.info : "No information here !")}</textarea>
                            ...
                            <div class="button-group" id="editButtonGroup">
                                ...
                                <button type="button" class="cancel-button"
                                        onclick="window.location.href = 'aboutInform?userInform=${currentUsername != null ? currentUsername : param.userInform}'">
                                    Cancel
                                </button>
                            </div>
                        </form>
